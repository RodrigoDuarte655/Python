...
class CtrlCurso():
    ...
    def insereHandler(self, event):
        ...
        Exemplos: 'SIN', 'CC01', '12345', 'ECO15' ...""")
            ...
            self.limiteIns.mostraJanela('Erro', 'Este curso já foi cadastrado!')
        except NomeDuplicado:
            self.limiteIns.mostraJanela('Erro', 'Já existe um curso com este nome!')
            self.limiteIns.inputNome.delete(0, len(self.limiteIns.inputNome.get()))
        except CodeDuplicado:
            self.limiteIns.mostraJanela('Erro', 'Já existe um curso com este código!')
            self.limiteIns.inputCode.delete(0, len(self.limiteIns.inputCode.get()))
            ...
            self.limiteIns.mostraJanela('Inserção realizada', 'Curso cadastrado com sucesso!')
            self.limiteIns.inputNome.delete(0, len(self.limiteIns.inputNome.get()))
            self.limiteIns.inputCode.delete(0, len(self.limiteIns.inputCode.get()))
